...
coding_file <- "/scratch/ref/protein_coding_ensembl_ids.txt"
pc_genes    <- read_lines(coding_file)

# rare-variant IDs for this chromosome
rare <- read_lines(file.path(work, paste0("rare_chr", chr, ".snplist")))

vep <- read_tsv
          file.path(base, "data", "LEEDS_CIpheno.vep.tsv"),
