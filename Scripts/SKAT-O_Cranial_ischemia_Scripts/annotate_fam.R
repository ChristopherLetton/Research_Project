setwd("/scratch/jsxm6270/gca_skat_V2/data")
...
fam <- read.table("/scratch/jsxm6270/gca_skat_V2/LEEDS_Freeze_One.GL.splitmulti.fam", header=FALSE)
...
# Save updated .fam
write.table(fam_updated, file="/scratch/jsxm6270/gca_skat_V2/data/LEEDS_CIpheno.fam",
